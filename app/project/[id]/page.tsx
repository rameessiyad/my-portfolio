    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4 mb-8">
          <div>
            <span
              className="text-xs font-medium tracking-widest uppercase mb-3 px-4 py-1.5 rounded-full inline-block"
              style={{
                color: "#22c55e",
          ...
          >
            Visit Site <FiArrowUpRight size={16} />
          </a>
        </div>
          ...
          {project.images.map((img, i) => (
            <button
              ...
              style={{
                ...
                boxShadow:
                  i === activeImg ? "0 0 12px rgba(34,197,94,0.3)" : "none",
